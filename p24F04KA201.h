/*-------------------------------------------------------------------------
 * MPLAB-Cxx  PIC24F04KA201 processor header
 *
 * (c) Copyright 1999-2010 Microchip Technology, All rights reserved
 *-------------------------------------------------------------------------*/

#ifndef __PIC24F04KA201__
#error "Include file does not match processor setting"
#endif

#ifndef __24F04KA201_H
#define __24F04KA201_H
...
#define BORV_27V             0xFFBF
#define BORV_20V             0xFFDF
#define BORV_18V             0xFFFF
...
**
**   Deep Sleep BOR:
**     DSLPBOR_OFF          Disabled
**     DSLPBOR_ON           Enabled
**
**   Deep Sleep Watchdog Oscillator Clock Select:
**     DSWCKSEL_LPRC        Secondary Oscillator (SOSC)
**     DSWCKSEL_SOSC        Low Power RC Oscillator (LPRC)
**
...
#define DSLPBOR_OFF          0xFFBF
#define DSLPBOR_ON           0xFFFF

#define DSWCKSEL_LPRC        0xFFEF
#define DSWCKSEL_SOSC        0xFFFF
