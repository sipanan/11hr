...
// Associate the physical layer functions with the correct physical layer
    ...
    #define USB_MDD_MediaInitialize     USBHostMSDSCSIMediaInitialize
    #define USB_MDD_MediaDetect         USBHostMSDSCSIMediaDetect
    #define USB_MDD_SectorRead          USBHostMSDSCSISectorRead
    #define USB_MDD_SectorWrite         USBHostMSDSCSISectorWrite
    #define USB_MDD_InitIO();              
    #define USB_MDD_ShutdownMedia       USBHostMSDSCSIMediaReset
    #define USB_MDD_WriteProtectState   USBHostMSDSCSIWriteProtectState
